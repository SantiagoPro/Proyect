...
public class AdministradorJpaController implements Serializable {
    ...
    public void create(Administrador administrador) throws IllegalOrphanException, PreexistingEntityException, RollbackFailureException, Exception {
    ...
    public void edit(Administrador administrador) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Long id = administrador.getIdAdministrador();
